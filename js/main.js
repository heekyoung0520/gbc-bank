...
// } else {
//   document.getElementById('balance').classList.add('plus');
// }


// var _balanceColor = document.getElementById('balance');
//   if (balance < 0) {
//   _balanceColor.classList.add('minus');
// } else {
//   _balanceColor.classList.add('plus');
// }
